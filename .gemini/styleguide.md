...
# Introduction
This style guide outlines the coding conventions for Python code development.
...
# Tooling
* **Code formatter and Linter:**  Use `ruff` for formatter and linter - Enforces consistent formatting automatically and Identifies potential issues and style violations.
